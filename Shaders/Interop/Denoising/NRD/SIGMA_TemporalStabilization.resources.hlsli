...
NRD_INPUTS_START
    ...
    NRD_INPUT( Texture2D, float, gIn_Penumbra, 2 )
    NRD_INPUT( Texture2D, SIGMA_TYPE, gIn_Shadow_Translucency, 3 )
    NRD_INPUT( Texture2D, SIGMA_TYPE, gIn_History, 4 )
    NRD_INPUT( Texture2D, uint, gIn_HistoryLength, 5 )
    NRD_INPUT( Texture2D, float2, gIn_Tiles, 6 )
NRD_INPUTS_END

NRD_OUTPUTS_START
    NRD_OUTPUT( RWTexture2D, SIGMA_TYPE, gOut_Shadow_Translucency, 0 )
    NRD_OUTPUT( RWTexture2D, uint, gOut_HistoryLength, 1 )
NRD_OUTPUTS_END
